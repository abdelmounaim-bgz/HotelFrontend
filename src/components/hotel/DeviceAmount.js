        ...
        <tr>
          <td > 
            <center>
              ...
              <p ><a style={{color: '#808080'}}>{t("Serrure")}: </a>{props.Hotel.device_ammount}</p>
            </center>
          </td>
          <td>
            <center>
              <img src={Reseau}alt="AdminLTE Logo" className="brand-image mb-2 "  />
              <p><a style={{color: '#808080'}}>{t("Dispositif réseau")}:</a> {props.Hotel.device_ammount}</p>
            </center>
          </td>
        </tr>
        <tr>
          <td >
            <center>
              ...
              <p><a style={{color: '#808080'}}>{t("Contrôleur d'ascenceur")}:</a> {props.Hotel.device_ammount}</p>
            </center>
          </td>
          <td >
            <center>
              <img src={ModeEco}alt="AdminLTE Logo" className="brand-image mb-2 " />
                <p><a style={{color: '#808080'}}>{t("Mode éco")}:</a> {props.Hotel.device_ammount}</p>
            </center>
          </td>
        </tr>
      </tbody>
